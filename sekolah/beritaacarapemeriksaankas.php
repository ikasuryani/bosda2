    ...
    <body>
        <div class="container">
            ...
            <div class="sixteen columns" style="position: relative; z-index: -1;">
                <!-- <div class="h-border"> -->
                    <div class="heading" style="margin-top: 20px; margin-bottom: 20px;">
                        <h1>Berita Acara Pemeriksaan Kas</h1>
                    </div>
                <!-- </div> -->
            </div>
            ...
            <div class="row" id="buatbaru" style="display: block; margin-top: -20px;">
                <center><h1>Buat Baru Berita Acara Pemeriksaan Kas</h1></center>
                <br><br>
                <form>
                <p >
                    Pada hari ini <input type="text" name="" size="7"> tanggal <input type="text" name="" size="4"> tahun <input type="text" name="" size="3"> yang bertanda tangan di bawah ini, kami Kepala Sekolah yang dutunjuk berdasarkan Surat Keputusan No. <input type="text" name="" size="10"> tanggal <input type="text" name="" size="4"><br>
                    <table class="pure-table pure-table-form">
                        <tr>
                            <td><label>Nama</label></td>
                            <td style="width: 1px;">:</td>
                            <td align="left"><input type="text" name="tgl1" size="20"></td>
                        </tr>
                        <tr>
