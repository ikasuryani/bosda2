...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into dtlbkkas(tanggal,idbkkas,nokode,nobukti,uraian, jenispenerimaan, penerimaandebit, pengeluarankredit) value('$tanggal','$idbkkas','$kode','$bukti','$uraian', '$jenisp', '$debit','$kredit')";
                    ...
                    <center>
                        <form class="pure-form" method="POST">
                            <table class="pure-table pure-table-form">
                                ...
                                <tr>
                                    <td><label>Jenis Penerimaan </label></td>
                                    <td style="width: 1px;">:</td>
                                    <td align="left">
                                        <select name="jenisp">
                ...
                <div class="row" id="lihat" style=" <?php if (!isset($_POST["submittahun"])) { ?> display: none;<?php } ?> margin-top: -20px;">
                    ...
                    <form method="POST" action="bkumum.php">
                        ...
                        <table id="bkutambah" border="1" class="pure-table pure-table-bordered" style="width: 99%; margin-right: 20px;">
                            ...
                            $queryz = "SELECT dtl.tanggal,dtl.nokode,dtl.nobukti,dtl.uraian, dtl.jenispenerimaan, dtl.penerimaandebit,dtl.pengeluarankredit, (dtl.penerimaandebit-dtl.pengeluarankredit) as saldo from dtlbkkas dtl inner join bkkas bk on dtl.idbkkas = bk.id where dtl.idbkkas=$idbkkas and bk.idsekolah = '" . $_SESSION['idsekolah'] . "' $where";
                            ...
                            while ($rowz = mysql_fetch_assoc($resultz)) {
                                ...
                                echo "<td>" . $rowz['jenispenerimaan'] . "</td>";
